...
export const APP_LANGUAGE_COPY: Record<AppLanguage, AppLanguageCopy> = {
  'pt-BR': {
    nav: {
    ...
    auth: {
      ...
      signUp: {
        ...
        emailLabel: 'Usuário',
        emailPlaceholder: 'leitor-local',
        error: 'Não consegui criar a conta local. Atualize esta aba e tente de novo.',
        nameLabel: 'Nome',
        namePlaceholder: 'Como você quer aparecer',
        passwordLabel: 'Senha',
  ...
  en: {
    ...
    auth: {
      ...
      signUp: {
        ...
        emailLabel: 'Username',
        emailPlaceholder: 'local-reader',
        error: 'We could not create the local account. Refresh this tab and try again.',
        nameLabel: 'Name',
        namePlaceholder: 'How you want to appear',
        passwordLabel: 'Password',
  ...
  es: {
    ...
    auth: {
      ...
      signUp: {
        ...
        emailLabel: 'Usuario',
        emailPlaceholder: 'lector-local',
        error: 'No pudimos crear la cuenta local. Actualiza esta pestaña e inténtalo de nuevo.',
        nameLabel: 'Nombre',
        namePlaceholder: 'Cómo quieres aparecer',
        passwordLabel: 'Contraseña',
        passwordPlaceholder: 'Mínimo de 8 caracteres',
